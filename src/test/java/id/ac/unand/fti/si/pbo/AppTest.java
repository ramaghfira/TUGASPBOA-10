...
public class AppTest {
    ...
    public void testKelasMemberRegulerExists(){
        try {
            Class.forName("id.ac.unand.fti.si.pbo.MemberReguler");
    ...
    public void testKelasMemberSilverExists(){
        try {
            ...
            Class.forName("id.ac.unand.fti.si.pbo.MemberSilver");
    ...
    public void testKelasMemberGoldExists(){
        try {
            Class.forName("id.ac.unand.fti.si.pbo.MemberGold");
    ...
    public void testKelasMemberPlatinumExists(){
        try {
            Class.forName("id.ac.unand.fti.si.pbo.MemberPlatinum");
